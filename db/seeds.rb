...
reviews = [
  ...
  { reviewer: Faker::Name.name, rating: 5, description: "OMG, Cannabis Absinthe gets you high and drunk at the same time. It goes really well with cheese (just like a fine bottle of wine) you will be surprised!!!!", product_id: Product.find_by(name: "Cannabis Absinthe").id },
  { reviewer: Faker::Name.name, rating: 5, description: "Whoever invented this drink is a genius. It hits me so hard that I became a dance machine despite being an introvert :)", product_id: Product.find_by(name: "Cannabis Absinthe").id },
